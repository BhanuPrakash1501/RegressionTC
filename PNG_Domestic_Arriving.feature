...
Feature: Validate the Functionality of File A Complaint by selecting Penang International Airport
Scenario: Verify that user should File A Complaint
   ...
   Then Click on the Feedback Icon in the my profile page
    ...
    And click on Penang International Airport
   ...
   Then select the travel type as Domestic
    ...
    And click on each Touch point for Penang International Airport
